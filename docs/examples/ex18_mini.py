"""MINI element for two-dimensional Stokes equations.
...
i.e. velocity and pressure, as in ex18, but using the MINI element instead of the Taylor&ndash;Hood.
"""
...
element = {'u': ElementVectorH1(ElementTriMini()),
           'p': ElementTriP1()}
...
basis['psi'] = InteriorBasis(mesh, basis['u'].elem.elem, quadrature=basis['u'].quadrature)
